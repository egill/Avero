...
echo "🖥️  Deploying gateway-tui to Netto"
...
echo "✅ Deployed gateway-tui to Netto"
echo "Run with: ssh $HOST '/opt/avero/gateway-poc/target/release/gateway-tui --config /opt/avero/gateway-poc/config/netto.toml'"
