...
- `progress-bench.txt` — session memory for Ralph iterations
...
- Temporary notes
- Info already in progress-bench.txt
```
...
**CRITICAL**: Use production code as reference. Do not improvise.
...
### Go (Avero)
- RS485 protocol: `~/Documents/GitHub/Avero/internal/rs485/protocol.go`
- RS485 controller: `~/Documents/GitHub/Avero/internal/rs485/controller.go`
- CloudPlus: `~/Documents/GitHub/Avero/internal/cloudplus/protocol.go`
