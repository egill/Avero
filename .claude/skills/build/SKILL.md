---
name: build
description: Build gateway for different targets (macOS, Linux aarch64, Raspberry Pi). Use when building the Rust application for local development or cross-compilation.
---
