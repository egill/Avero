...
fn format_prometheus_metrics(
    ...
    output.push_str(&format!(
        "gateway_event_latency_us_bucket{{le=\"+Inf\"}} {}\n",
        cumulative
    ));
    ...
    output.push_str(&format!(
        "gateway_stitch_distance_cm_sum {}\n",
        stitch_dist_sum
    ));
    output.push_str(&format!(
        "gateway_stitch_distance_cm_count {}\n",
        stitch_dist_count
    ));
